...
packageSender.Send(new MyPackage { Message = "Hello" });		
		\end{lstlisting}	
		\item Η ρύθμιση και το API του client είναι πανομοιότυπo με του server. Στη θέση του NetworkServer χρησιμοποιείται ο NetworkClient όπου και τα δύο υλοποιούν τον NetworkManager<TPeer> where TPeer:NetPeer			
	\end{itemize}
	\chapter{Game Host}
