...
\bibliography{C:/Users/George/Documents/GitHub/GemReport/Presentation/Content/bibliography}
...
\begin{document}
	...
	\begin{frame}{Πως ορίζεται ένα παιχνίδι; I}
		\begin{itemize}
			\item Ένα σύνολο παραγόντων οι οποίοι δρουν βάση στρατηγικών και τεχνικών, με στόχο να μεγιστοποιήσουν τα κέρδη μέσα στον εικονικό κόσμο, μέσα σε ένα πλαίσιο καλά ορισμένων κανόνων. \footfullcite{gametheory}
